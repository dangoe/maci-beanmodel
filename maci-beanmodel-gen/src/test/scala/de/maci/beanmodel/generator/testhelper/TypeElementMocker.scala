...
final class TypeElementMocker private () extends Mocker[TypeElement] {
  ...
  private val _modifiersBuilder: mutable.Builder[Modifier, Set[Modifier]] = Set.newBuilder[Modifier]
  private val _enclosedElementsBuilder: mutable.Builder[Element, Set[Element]] = Set.newBuilder[Element]
  ...
  def withEnclosedElements(elements: Element*): this.type = withEnclosedElements(elements.toSet)

  def withEnclosedElements(elements: Iterable[Element]): this.type = { _enclosedElementsBuilder.clear(); _enclosedElementsBuilder ++= elements; this }
